 ...
 */
final class Version20240628170305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exercise_log (id INT AUTO_INCREMENT NOT NULL, workout_id INT NOT NULL, exercise_id INT NOT NULL, nr_reps INT NOT NULL, duration TIME NOT NULL, INDEX IDX_1960CDB9A6CCCFC9 (workout_id), INDEX IDX_1960CDB9E934951A (exercise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
